...
/*float offsetA[3] = {0,0,0};
float offsetB[3] = {0,0,0};
float offsetC[3] = {0,0,0};*/
...
//	printfloat(sfA[0]);
	...
	/*printstr("coord zero\r\n");
	  	...
	  	printfloat(coord_zero_A[2]);
		printfloat(coord_zero_B[2]);
		printfloat(coord_zero_C[2]);
		printstr("\r\n\r\n");

	  printstr("dec carretka\r\n");
		printfloat(absA[2]);
		printfloat(absB[2]);
		printfloat(absC[2]);
		printstr("\r\n\r\n");*/
...
/*	printfloat(max_speed);
	printfloat(time_of_accel);
	printfloat(time_of_max_speed);
	printfloat(time_of_brake);
	printfloat(pulses_of_accel);
	printfloat(pulses_of_brake);
	printfloat(pulses_of_max_speed);
	printfloat(pulses_of_accel+pulses_of_max_speed);
